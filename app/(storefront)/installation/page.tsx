...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: copyValue(copy, "services.installation.metaTitle"),
    description: copyValue(copy, "services.installation.metaDescription"),
  };
}
...
export default async function InstallationPage() {
  ...
  const steps = [
    [
      ClipboardCheck,
      c("services.installation.step1.title"),
      c("services.installation.step1.description"),
    ],
    [
      HardHat,
      c("services.installation.step2.title"),
      c("services.installation.step2.description"),
    ],
    [
      ShieldCheck,
      c("services.installation.step3.title"),
      c("services.installation.step3.description"),
    ],
  ];
  return (
          ...
          <Suspense
            fallback={
              <div className="surface-card p-8 text-sm text-muted-foreground">
                {c("services.installation.loading")}
              </div>
            }
          >
